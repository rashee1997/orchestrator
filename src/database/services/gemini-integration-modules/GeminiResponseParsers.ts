...
export async function parseGeminiJsonResponse(
    ...
    try {
        ...
        // Detect a markdown block (`````` or just ``````)
        ...
        try {
            ...
            // Recovery Strategy 1: Try chunked repair for large responses (NEW)
            ...
            // Recovery Strategy 2: Try to complete incomplete JSON objects
            ...
            try {
                ...
                console.warn('[JSON Parser] Recovery strategy 2 failed:', recoveryError.message);
            }

            // Recovery Strategy 3: Try AI repair before manual extraction for complex responses
            ...
            // Recovery Strategy 4: Extract key-value pairs manually for simple RAG structures only (as last resort)
